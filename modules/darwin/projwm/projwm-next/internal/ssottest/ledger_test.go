...
var ssotLedger = []ledgerItem{
	...
	{ID: "OP-14", Section: "§4.1/§10.6", Layer: "L1/L4", Subject: "browser add-tab appends tab to browser window (S14 第一段階: PrivatePayloadStore proper wiring は S20 で実施)", TestPath: "internal/intent/ssot_l0_intent_test.go internal/reducer/reducer_browser_test.go cmd/projwm/ssot_cli_surface_test.go scenarios/ssot_real_acceptance_test.go", TestName: "TestSSOTUserOperationsHaveIntentSurface/TestReduceIntent_BrowserAddTab_AppendsURL/TestReduceIntent_BrowserOps_RejectNonBrowserWindow/TestSSOTCLIExposesBrowserTabOperations/TestHumanE2ESSOTBrowserTabOperationsUpdatePrivateMetadataSteps", Status: statusRealOnly, Evidence: evidenceBehavior},
	{ID: "OP-15", Section: "§4.1/§10.6", Layer: "L1/L4", Subject: "browser remove-tab removes tab and closes window if last tab (planner-level close, S14 第一段階)", TestPath: "internal/intent/ssot_l0_intent_test.go internal/reducer/reducer_browser_test.go cmd/projwm/ssot_cli_surface_test.go scenarios/ssot_real_acceptance_test.go", TestName: "TestSSOTUserOperationsHaveIntentSurface/TestReduceIntent_BrowserRemoveTab_RemovesAtIndex/TestReduceIntent_BrowserRemoveTab_OutOfRangeErrors/TestSSOTCLIExposesBrowserTabOperations/TestHumanE2ESSOTBrowserTabOperationsUpdatePrivateMetadataSteps", Status: statusRealOnly, Evidence: evidenceBehavior},
	{ID: "OP-16", Section: "§4.1/§10.6", Layer: "L1/L4", Subject: "browser tab URL change updates DesiredWorld ref (PrivatePayloadStore wiring deferred to S20)", TestPath: "internal/intent/ssot_l0_intent_test.go internal/reducer/reducer_browser_test.go cmd/projwm/ssot_cli_surface_test.go scenarios/ssot_real_acceptance_test.go", TestName: "TestSSOTUserOperationsHaveIntentSurface/TestReduceIntent_BrowserChangeTabURL_Replaces/TestSSOTCLIExposesBrowserTabOperations/TestHumanE2ESSOTBrowserTabOperationsUpdatePrivateMetadataSteps", Status: statusRealOnly, Evidence: evidenceBehavior},
	{ID: "OP-17", Section: "§4.1/§10.6", Layer: "L1/L4", Subject: "browser tab reorder updates DesiredWorld structure", TestPath: "internal/intent/ssot_l0_intent_test.go internal/reducer/reducer_browser_test.go cmd/projwm/ssot_cli_surface_test.go scenarios/ssot_real_acceptance_test.go", TestName: "TestSSOTUserOperationsHaveIntentSurface/TestReduceIntent_BrowserReorderTabs_MovesFromTo/TestReduceIntent_BrowserReorderTabs_SameFromToIsNoop/TestSSOTCLIExposesBrowserTabOperations/TestHumanE2ESSOTBrowserTabOperationsUpdatePrivateMetadataSteps", Status: statusRealOnly, Evidence: evidenceBehavior},
