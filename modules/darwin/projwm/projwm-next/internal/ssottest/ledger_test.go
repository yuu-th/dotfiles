...
var ssotLedger = []ledgerItem{
	...
	// §4.1 user operations.
	{ID: "OP-01", Section: "§4.1/§10.6", Layer: "L1/L2/L3/L4", Subject: "slot shell jump summons shell-1 and cycles shells", TestPath: "internal/intent/ssot_l0_intent_test.go scenarios/ssot_real_acceptance_test.go internal/ssottest/real_ops_coverage_test.go scenarios/ssot_l4_acceptance_coverage_test.go", TestName: "TestSSOTUserOperationsHaveIntentSurface/TestHumanE2ESSOTJumpOperationsFocusExpectedWindowsSteps/TestHumanE2ESSOTSummonIdempotencySteps/TestSSOTRealOpsCoverageGate/TestSSOTL4AcceptanceCoverageGate", Status: statusRed, Evidence: evidenceMixed},
	{ID: "OP-02", Section: "§4.1/§10.6", Layer: "L1/L2/L3/L4", Subject: "slot editor jump summons editor-1 and cycles editors", TestPath: "internal/intent/ssot_l0_intent_test.go scenarios/ssot_real_acceptance_test.go internal/ssottest/real_ops_coverage_test.go scenarios/ssot_l4_acceptance_coverage_test.go", TestName: "TestSSOTUserOperationsHaveIntentSurface/TestHumanE2ESSOTJumpOperationsFocusExpectedWindowsSteps/TestSSOTRealOpsCoverageGate/TestSSOTL4AcceptanceCoverageGate", Status: statusRed, Evidence: evidenceMixed},
	{ID: "OP-03", Section: "§4.1/§10.6", Layer: "L1/L2/L3/L4", Subject: "slot browser jump summons browser-1 and cycles browsers", TestPath: "internal/intent/ssot_l0_intent_test.go scenarios/ssot_real_acceptance_test.go internal/ssottest/real_ops_coverage_test.go scenarios/ssot_l4_acceptance_coverage_test.go", TestName: "TestSSOTUserOperationsHaveIntentSurface/TestHumanE2ESSOTJumpOperationsFocusExpectedWindowsSteps/TestSSOTRealOpsCoverageGate/TestSSOTL4AcceptanceCoverageGate", Status: statusRed, Evidence: evidenceMixed},
	{ID: "OP-04", Section: "§4.1/§10.6", Layer: "L1/L4", Subject: "project switch focuses last focused window in target slot", TestPath: "internal/intent/ssot_l0_intent_test.go scenarios/ssot_real_acceptance_test.go scenarios/ssot_l4_acceptance_coverage_test.go", TestName: "TestSSOTUserOperationsHaveIntentSurface/TestHumanE2ESSOTProjectSwitchAndSameSlotWindowSwitchSteps/TestSSOTL4AcceptanceCoverageGate", Status: statusRed, Evidence: evidenceMixed},
	{ID: "OP-05", Section: "§4.1/§10.6", Layer: "L1/L2/L4", Subject: "same-slot window switch changes focus without workspace change", TestPath: "internal/intent/ssot_l0_intent_test.go scenarios/ssot_real_acceptance_test.go scenarios/ssot_l4_acceptance_coverage_test.go", TestName: "TestSSOTUserOperationsHaveIntentSurface/TestHumanE2ESSOTProjectSwitchAndSameSlotWindowSwitchSteps/TestSSOTL4AcceptanceCoverageGate", Status: statusRed, Evidence: evidenceMixed},
	{ID: "OP-06", Section: "§4.1/§10.6", Layer: "L1/L3/L4", Subject: "viewer jump focuses viewer workspace A", TestPath: "internal/intent/ssot_l0_intent_test.go scenarios/ssot_real_acceptance_test.go internal/ssottest/real_ops_coverage_test.go scenarios/ssot_l4_acceptance_coverage_test.go", TestName: "TestSSOTUserOperationsHaveIntentSurface/TestHumanE2ESSOTJumpOperationsFocusExpectedWindowsSteps/TestSSOTRealOpsCoverageGate/TestSSOTL4AcceptanceCoverageGate", Status: statusRed, Evidence: evidenceMixed},
	...
	{ID: "OP-11", Section: "§4.1/§10.6", Layer: "L1/L3/L4", Subject: "scratch shell open/close restores prior focus", TestPath: "internal/intent/ssot_l0_intent_test.go internal/adapter/wm/ssot_l3_wm_spec_test.go scenarios/ssot_real_acceptance_test.go", TestName: "TestSSOTUserOperationsHaveIntentSurface/TestScratchShellShowHideRestoresPriorFocus/TestHumanE2ESSOTScratchShellOpenCloseSteps", Status: statusRed, Evidence: evidenceMixed},
	{ID: "OP-12", Section: "§4.1/§10.6", Layer: "L0/L1/L2/L3/L4", Subject: "add-window uses max id + 1 without hole reuse", TestPath: "internal/reducer/ssot_l0_state_test.go scenarios/ssot_real_acceptance_test.go internal/ssottest/real_ops_coverage_test.go scenarios/ssot_l4_acceptance_coverage_test.go", TestName: "TestSSOTWindowIndexAllocationNeverReusesDeletedIDs/TestHumanE2ESSOTAddWindowCreatesNextShellAndPlacesItSteps/TestSSOTRealOpsCoverageGate/TestSSOTL4AcceptanceCoverageGate", Status: statusRed, Evidence: evidenceMixed},
	...
	{ID: "L2-F", Section: "§10.4", Layer: "L2", Subject: "focus command-order deterministic harness F5", TestPath: "internal/adapter/wm/ssot_l2_mock_executor_test.go", TestName: "TestFocusWindowNavigationBeforeFocus", Status: statusRed},
